...
const BLOG = {
  ...
  AUTHOR: 'KentCraft', // 作者
  BIO: '一个致力于打造全天下玩家梦想家园的平台', // 作者简介
  LINK: 'https://club.kentcraft.cn', // 网站地址
  KEYWORDS: 'KentCraft, Minecraft, 我的世界, 俱乐部, 游戏, Warframe, ECO', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '', // 邮箱
  CONTACT_WEIBO: 'https://space.bilibili.com/282524757', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/JohnnyWoong', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/kentcraft', // 你的telegram 地址 例如 https://t.me/tangly_1024
